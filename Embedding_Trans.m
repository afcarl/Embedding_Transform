...
%%
function [beta_all, beta_tr] = Embedding_Trans(X,M)
% INPUTS:
...
% events, neuromodulations, or phasic events
% OUTPUTS:
...
beta_all = zeros(0,0);
for i = 1:n_tr
    [~, beta_aux] = Embedding_Trans_all(X{i,1},M,X_pks{i,1});
...
% OUTPUTS:
% beta_aux - Amplitude/Norm of all possible M-dimensional snippets, i.e. 
% Embedding Transform
